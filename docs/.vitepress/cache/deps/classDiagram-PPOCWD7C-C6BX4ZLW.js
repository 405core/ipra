import {
  ...
  ct,
  qt
} from "./chunk-D3EP4QLI.js";
import "./chunk-NFYNFPBA.js";
import "./chunk-TEJXR2YZ.js";
...
// node_modules/.pnpm/mermaid@11.14.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/classDiagram-PPOCWD7C.mjs
var n = { parser: Et, get db() {
  return new ct();
}, renderer: qt, styles: Ut, init: m((r) => {
  r.class || (r.class = {}), r.class.arrowMarkerAbsolute = r.arrowMarkerAbsolute;
}, "init") };
export {
  n as diagram
};
//# sourceMappingURL=classDiagram-PPOCWD7C-C6BX4ZLW.js.map
