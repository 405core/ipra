...
type HistoryTabKey = 'scan' | 'audit';

const activeTab = ref<HistoryTabKey>('audit');
const query = ref('');
  ...
  <section class="history-page">
    <section class="history-shell">
      <div class="history-topbar">
        ...
        <div v-if="activeTab === 'audit'" class="history-topbar__audit">
          <input
            v-model="query"
            class="history-topbar__input"
            type="text"
            inputmode="search"
            placeholder="筛选操作、资源、路径"
          />
          <span class="history-topbar__meta">当前展示 {{ filteredLogs.length }} / {{ total }} 条</span>
      ...
      <section v-if="activeTab === 'scan'" class="history-placeholder">
